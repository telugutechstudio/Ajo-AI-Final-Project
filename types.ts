...
export type Tool = 'SCRIBE' | 'OCR' | 'IMAGES_TO_PDF' | 'MERGE_PDF' | 'SPLIT_PDF' | 'COMPRESS_PDF' | 'PDF_TO_WORD' | 'PDF_TO_EXCEL' | 'PDF_TO_PPT' | 'PDF_TO_IMAGE' | 'SCAN_TO_PDF' | 'AI_CHAT' | 'AI_CHATBOT_BUILDER' | 'KNOWLEDGE_DOCUMENT' | 'AI_POLISH' | 'AI_TRANSLATE' | 'LIVE_TRANSLATE';
...
export enum AppScreen {
  ...
  LIVE_TRANSLATE_VIEW = 'LIVE_TRANSLATE_VIEW',
